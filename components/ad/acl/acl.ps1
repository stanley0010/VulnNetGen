...
SetAcl (Get-ADUser "$genericall_user_from_username") (Get-ADUser "$genericall_user_to_username") "GenericAll" "None"
...
SetAcl (Get-ADUser "$genericall_group_from_username") (Get-ADGroup "$genericall_group_to_group") "GenericAll" "None"
...
SetAcl (Get-ADUser "$genericall_computer_from_username") (Get-ADComputer "$genericall_computer_to_machine_name") "GenericAll" "None"
...
SetAcl (Get-ADUser "$writeproperty_group_from_username") (Get-ADGroup "$writeproperty_group_to_group") "WriteProperty" "All"
...
SetAclExtended (Get-ADUser "$selfselfmembership_from_username") (Get-ADGroup "$selfselfmembership_to_group") "Self" "bf9679c0-0de6-11d0-a285-00aa003049e2" "None"
...
SetAclExtended (Get-ADUser "$writeproperty_selfmembership_from_username") (Get-ADGroup "$writeproperty_selfmembership_to_group") "WriteProperty" "bf9679c0-0de6-11d0-a285-00aa003049e2" "All"
...
SetAclExtended (Get-ADUser "$forcechangepassword_from_username") (Get-ADUser "$forcechangepassword_to_username") "ExtendedRight" "00299570-246d-11d0-a768-00aa006e0529" "None"
...
SetAcl (Get-ADUser "$writeowner_from_username") (Get-ADGroup "$writeowner_to_group") "WriteOwner" "None"
...
SetAcl (Get-ADUser "$genericwrite_from_username") (Get-ADUser "$genericwrite_to_username") "GenericWrite" "None"
...
SetAcl (Get-ADUser "$writedacl_from_username") (Get-ADGroup "$writedacl_to_group") "WriteDacl" "None"
