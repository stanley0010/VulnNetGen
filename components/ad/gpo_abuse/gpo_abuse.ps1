...
if ($gpo_exist) {
    ...
    New-GPLink -Name "StarkWallpaper" -Target "$DC_path"
    ...
    Set-GPPermissions -Name "StarkWallpaper" -PermissionLevel GpoEditDeleteModifySecurity -TargetName "$username" -TargetType "User"
}