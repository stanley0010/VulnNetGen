...
def get_scenario_list():
    directory = "../scenarios"
    return [
        name for name in os.listdir(directory) if os.path.isdir(directory + "/" + name)
    ]
...
@click.option(
    ...
    "--scenario",
    "scenario",
    default="linux_default_ftp",
    show_default="linux_default_ftp",
    required=True,
    prompt="Please enter the scenario",
